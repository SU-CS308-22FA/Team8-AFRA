...
export const UserSettings = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:4000/api/app/userSettings', registered)
        .then(response =>
            {
    ...
    return (
        ...
        <button className="link-btn" onClick={() => axios.post('http://localhost:4000/api/app/delete', {email: email})
        .then(response =>
            {
                if( response.data === "done")
                {
